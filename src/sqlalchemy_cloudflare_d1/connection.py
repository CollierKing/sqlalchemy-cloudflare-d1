...
class CloudflareD1Connection:
    ...
    def execute(self, query: str, parameters: Optional[Sequence] = None) -> 'CloudflareD1Result':
        """Execute a SQL query.
    ...
    def execute_many(self, query: str, parameters_list: List[Sequence]) -> List['CloudflareD1Result']:
...
class CloudflareD1Result:
    ...
    def __init__(self, results: List[Dict[str, Any]], meta: Dict[str, Any], success: bool = True):
